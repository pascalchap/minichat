| [Overview](overview-summary.html) | [![erlang logo](doc/erlang.png)](http://www.erlang.org/) |
|-----------------------------------|------------------------------------------------------|
...
![Structure of a running chat involving 3 users](doc/structure.png "Structure of a running chat involving 3 user")
...
![Screen capture of the chat in action](doc/minichat.png "chat with 3 users")
